...
def get_render3_cmap(
        ...
        render3_file: str = '/home/satwick22/fsl/lib/python3.10/site-packages/fsleyes/assets/colourmaps/render3.cmap'
):
...
def call_until_success(hrflib_url):
    while True:
        try:
            hrflib = get_hrflib(hrflib_url)
            break  # If function succeeds, break the loop
        except Exception as e:
